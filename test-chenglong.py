...
# 载入播放音频
file = QUrl.fromLocalFile('chenglong\cbgm.wav')  # 音频文件路径
...
if "__main__" == __name__:
    ...
    try:
        ...
        pass
    shutil.copy('chenglong\chaoticimpulse.wma', r'../Resources/chaoticimpulse.wma')
    ...
    while i < 1000:
        if hwnd:
            if j == 1:
                ...
                player.play("chenglong\chenglong.mp4")
